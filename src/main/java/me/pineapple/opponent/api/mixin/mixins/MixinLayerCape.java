...
import me.pineapple.opponent.api.utils.CapeUtil;
import me.pineapple.opponent.client.module.modules.other.HUD;
import me.pineapple.opponent.client.module.modules.visual.Capes;
...
public class MixinLayerCape {
    ...
    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        if (entitylivingbaseIn.hasPlayerInfo()) {
            boolean caped = HUD.INSTANCE.capes.getValue() && CapeUtil.CAPED_USERS.containsKey(entitylivingbaseIn.getUniqueID());
            if (!entitylivingbaseIn.isInvisible() && (caped || (entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && entitylivingbaseIn.getLocationCape() != null))) {
                ...
                if (itemstack.getItem() != Items.ELYTRA) {
                    ...
                    boolean noInterp = Capes.INSTANCE.isEnabled() && Capes.INSTANCE.capes.getValue();
